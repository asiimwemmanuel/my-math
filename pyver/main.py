...
if choice == "Q":
    ...
    main_quad = math_tools.my_math.quad_tools(
        quad_series[1] - quad_series[0],
        quad_series[2] - quad_series[1],
        (quad_series[2] - quad_series[1]) - (quad_series[1] - quad_series[0]),
    )
    ...
    while posn_to_find > 0:
        ...
        print(
            f"  > Term {posn_to_find}: {main_quad.get_quad_nth_v1(quad_series, posn_to_find)}"
        )
    print("\n:: program terminated")
    # ----------------------------------------------------------------------------------
